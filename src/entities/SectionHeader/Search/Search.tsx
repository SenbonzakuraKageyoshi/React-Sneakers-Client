...
const Search = ({ search, onSearchInputHandler }: Search) => {
  return (
    <div className={styles.searchWrapper}>
        ...
        <input value={search} onInput={(e) => onSearchInputHandler((e.target as HTMLInputElement).value)} type="search" className={styles.search} placeholder='Поиск'/>
    </div>
  )
}
