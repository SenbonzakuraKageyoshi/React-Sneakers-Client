...
import HeaderLink from '../../features/Header/HeaderLink/HeaderLink';
...
const Header = ({ setCartIsOpened }: Header) => {
  return (
            ...
            <div className={styles.headerContent}>
                <Link to="/" className={styles.headerLogoLink}>
                  ...
                  <div className={styles.logoText}>
                    <div className={styles.logoTextItem}>REACT SNEAKERS</div>
                    <div className={styles.logoTextItem}>Магазин лучших кроссовок</div>
                  </div>
                </Link>
                <div className={styles.headerNav}>
                  <CartButton price={1205} setCartIsOpened={setCartIsOpened}/>
