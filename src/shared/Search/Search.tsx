...
const Search = ({ search, setSearch }: Search) => {
  return (
    <div className={styles.searchWrapper}>
        ...
        <input value={search} onInput={(e) => setSearch((e.target as HTMLInputElement).value)} type="search" className={styles.search} placeholder='Поиск'/>
    </div>
  )
}
